            ...
            <table class="table table-striped table-hover" border="1" >
                ...
                <c:forEach var="listAccount" items="${listAccount}">
                    <tr>
                        ...
                        <td>
                                <%--                        data-toggle="modal"--%>
<%--                                                            <a href="/account?action=update&&id=${listAccount.id}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>Edit</a>--%>
                            <a onclick="return confirm('Are you sure?')" href="/account?action=delete&&id=${listAccount.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i>Delete</a>
                        </td>
                    </tr>
                </c:forEach>

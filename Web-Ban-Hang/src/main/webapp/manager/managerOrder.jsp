...
<%--                    </div>--%>
            ...
            <table class="table table-striped table-hover" border="1" >
                ...
                <c:forEach var="orderList" items="${orderList}">
                    <tr>
                        <td><a href="/order?action=orderDetail&id=${orderList.id}">Detail</a></td>
                        <td>${orderList.accountId}</td>
...
<%--                            <a href="/order?action=update&&id=${orderList.id}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>Detail</a>--%>
                            <a onclick="return confirm('Are you sure?')" href="/order?action=delete&&id=${orderList.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i>Delete</a>
                        </td>
                    </tr>
                </c:forEach>

        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <h2><a href="/views/index.jsp">Home</a>   <a href="/order">ManagerOrder</a> <a
                                href="/managerProduct?action=showListAccount">ManagerAccount</a></h2>
            ...
            <table class="table table-striped table-hover" border="1" >
                ...
                <c:forEach var="product" items="${productList}">
                    <tr>
                        <td><a href="/managerProduct?action=view&id=${product.id}">${product.name}</a></td>
                        <td>${product.price}$</td>
                        <td>${product.quantity}</td>
                        <td><img src="${product.img}" alt="Ảnh ở đây" height="300" width="300"></td>
                        <td>
                                <%--                        data-toggle="modal"--%>
                            <a href="/managerProduct?action=update&&id=${product.id}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>Edit</a>
                            <a onclick="return confirm('Are you sure?')" href="/managerProduct?action=delete&&id=${product.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i>Delete</a>
                        </td>
                    </tr>
                </c:forEach>
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/managerProduct?action=create">
...
<%--                    <div class="form-group">--%>
<%--                        <label>Action</label>--%>
<%--                        <input type="text" name="action1" class="form-control" required>--%>
<%--                    </div>--%>
<%--                    <div class="form-group">--%>
...
<%--                    <div class="form-group">--%>
<%--                        <label>Barrel</label>--%>
<%--                        <input type="text" name="barrel" class="form-control" required>--%>
<%--                    </div>--%>
<%--                    <div class="form-group">--%>
<%--                        <label>Weight</label>--%>

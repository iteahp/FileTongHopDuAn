        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>OrderDetail</h2>
                        <h2><a href="/views/index.jsp">Home</a> <a href="/managerProduct">ManagerProduct</a></h2>
            ...
            <table class="table table-striped table-hover" border="1" >
                ...
                <c:forEach var="orderList" items="${orderDetailList}">
                    <tr>
<%--                        <td><a href="/managerProduct?action=view&id=${orderList.id}">Detail</a></td>--%>
                        <td>${orderList.orderId}</td>
                        <td><a href="managerProduct?action=view&id=${orderList.productId}">${orderList.productId}</a></td>
                        <td>${orderList.quantity}</td>

                        <td>
                                <%--                        data-toggle="modal"--%>
                                <%--                            <a href="/order?action=update&&id=${orderList.id}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>Detail</a>--%>
                            <a onclick="return confirm('Are you sure?')" href="/order?action=deleteOrderDetail&&id=${orderList.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i>Delete</a>
                        </td>
                    </tr>
                </c:forEach>
